...
var gr4vyHelpers = require('./gr4vy');
var summaryHelpers = require('base/checkout/summary');
var formHelpers = require('base/checkout/formErrors');
var scrollAnimate = require('base/components/scrollAnimate');

/* Gr4vy Begin: - placeholder for gr4vy embed */
var embed;
/* Gr4vy End: - placeholder for gr4vy embed */
        ...
        var members = {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (!data.error) {
                                    ...
                                    /* Gr4vy Start : initialize Gr4vy embed after shipping data is saved */
                                    if ($(plugin).data('checkout-isgr4vyenabled')) {
                                        gr4vyHelpers.saveGr4vyData(data);
                                        embed = gr4vyHelpers.initializeGr4vyPayment();
                                    }
                                    /* Gr4vy end : initialize Gr4vy embed after shipping data is saved */
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.error) {
                                ...
                                /* Gr4vy - Begin: Submit Gr4vy embed */
                                embed.submit();
                                /* Gr4vy - End: Submit Gr4vy embed */
            ...
            handleNextStage: function (bPushState) {
                if (members.currentStage < checkoutStages.length - 1) {
                    ...
                    /* Gr4vy Start : if Gr4vy is enabled bypass stage update at payment step */
                    if ($(plugin).data('checkout-isgr4vyenabled') && checkoutStages[members.currentStage] !== 'payment') {
                        members.currentStage++;
                    }
                    /* Gr4vy end : if Gr4vy is enabled bypass stage update at payment step */
...
var exports = {
    /* Gr4vy Start : initialize Gr4vy on checkout page reload */
    initialize: function () {
        $('#checkout-main').checkout();
        const queryString = window.location.search;
        const urlParams = new URLSearchParams(queryString);
        var stage = urlParams.get('stage');
        if(stage === 'payment' && $('#checkout-main').data('checkout-isgr4vyenabled') ) {
            window.onload = function() {
                $('.gr4vy-container').empty();
                embed = gr4vyHelpers.initializeGr4vyPayment();
            };
        }
    },
    /* Gr4vy end : initialize Gr4vy on checkout page reload */
    ...
    /* Gr4vy Start : initialize Gr4vy trigger handler */
    reinitializeEmbed: function () {
        $('body').on('gr4vyCheckout:reIntialize', function (e) {
            embed = gr4vyHelpers.initializeGr4vyPayment();
        });
    }
     /* Gr4vy end : initialize Gr4vy trigger handler */
