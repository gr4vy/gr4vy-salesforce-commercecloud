...
function getSelectedPaymentInstruments(selectedPaymentInstruments) {
    return collections.map(selectedPaymentInstruments, function (paymentInstrument) {
        ...
        } else if (paymentInstrument.paymentMethod === Constants.GR4VY_ID) {
            results.gr4vyPaymentMethod = paymentInstrument.custom.gr4vyPaymentMethod;
            results.amountFormatted = formatMoney(paymentInstrument.paymentTransaction.amount);
        }
